...
为LightRAG构建MCP服务器。
此服务器应允许我输入任何查询文本，并使用四种不同的MCP工具执行搜索操作：Naive Search、Local Search、Global Search和Hybrid Search。

支持多种查询模式：

Naive Search：对插入的内容进行直接搜索。

Local Search：专注于在插入文档的有限本地上下文中检索结果。

Global Search：对整个数据集进行全面搜索。

Hybrid Search：结合本地和全局搜索的各个方面，以提高结果的相关性和一致性。

WORKING_DIR路径为: /Users/choizhang/LightRAG
...
### Response:
(lightrag) ➜  LightRAG /opt/miniconda3/envs/lightrag/bin/python /U
sers/choizhang/LightRAG/examples/lightrag_gemini.py
...
INFO: Process 33699 Shared-Data created for Single Process
DEBUG: LightRAG init with param:
  ...
  tokenizer = <lightrag.utils.TiktokenTokenizer object at 0x1214ad710>,
  tiktoken_model_name = gpt-4o-mini,
  chunking_func = <function chunking_by_token_size at 0x1206cb2e0>,
  embedding_func = {'embedding_dim': 1024, 'max_token_size': 8192, 'func': <function embedding_func at 0x12146c900>},
  embedding_batch_num = 32,
  embedding_func_max_async = 16,
  embedding_cache_config = {'enabled': True, 'similarity_threshold': 0.9},
  llm_model_func = <function llm_model_func at 0x12146c9a0>,
  ...
  convert_response_to_json_func = <function convert_response_to_json at 0x12070e2a0>,
  cosine_better_than_threshold = 0.2,
  _storages_status = StoragesStatus.NOT_CREATED

INFO: Loaded graph from ./lilei/graph_chunk_entity_relation.graphml with 15 nodes, 11 edges
INFO:nano-vectordb:Load (14, 1024) data
INFO:nano-vectordb:Init {'embedding_dim': 1024, 'metric': 'cosine', 'storage_file': './lilei/vdb_entities.json'} 14 data
INFO:nano-vectordb:Load (11, 1024) data
INFO:nano-vectordb:Init {'embedding_dim': 1024, 'metric': 'cosine', 'storage_file': './lilei/vdb_relationships.json'} 11 data
INFO:nano-vectordb:Load (1, 1024) data
INFO:nano-vectordb:Init {'embedding_dim': 1024, 'metric': 'cosine', 'storage_file': './lilei/vdb_chunks.json'} 1 data
INFO: Process 33699 initialized updated flags for namespace: [full_docs]
INFO: Process 33699 ready to initialize storage namespace: [full_docs]
INFO: Process 33699 KV load full_docs with 1 records
INFO: Process 33699 initialized updated flags for namespace: [text_chunks]
INFO: Process 33699 ready to initialize storage namespace: [text_chunks]
INFO: Process 33699 KV load text_chunks with 1 records
INFO: Process 33699 initialized updated flags for namespace: [entities]
INFO: Process 33699 initialized updated flags for namespace: [relationships]
INFO: Process 33699 initialized updated flags for namespace: [chunks]
INFO: Process 33699 initialized updated flags for namespace: [chunk_entity_relation]
INFO: Process 33699 initialized updated flags for namespace: [llm_response_cache]
INFO: Process 33699 ready to initialize storage namespace: [llm_response_cache]
INFO: Process 33699 KV load llm_response_cache with 6 records
INFO: Process 33699 initialized updated flags for namespace: [doc_status]
INFO: Process 33699 ready to initialize storage namespace: [doc_status]
INFO: Process 33699 doc status load doc_status with 1 records
INFO: Process 33699 storage namespace already initialized: [full_docs]
INFO: Process 33699 storage namespace already initialized: [text_chunks]
INFO: Process 33699 storage namespace already initialized: [llm_response_cache]
INFO: Process 33699 storage namespace already initialized: [doc_status]
DEBUG: Initialized Storages
INFO: Process 33699 Pipeline namespace initialized
DEBUG: Initialized Storages
DEBUG: Non-embedding cached hit(mode:hybrid type:query)
根据我所掌握的信息，韩梅梅是李进的妈妈，职业是初中物理老师，她的手机号码是18084268123。

## 参考文献
* [KG] ./ragtest/lilei/lilei_1.txt
* [DC] ./ragtest/lilei/lilei_1.txt
